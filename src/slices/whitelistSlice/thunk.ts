...
//     try {
//       // simple GET, koi params nahi bhejne
...
//       toast.success(response.message || "IP added successfully", {
//         autoClose: 3000,
//       });
//       return response;
//     } catch (error: any) {
...
//       toast.success(response?.message || "IP deleted successfully", {
//         autoClose: 3000,
//       });
//       return response;
//     } catch (error: any) {
