...
export default function navdata(role: "user" | "admin") {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        { id: "aadharokyc", label: "Aadhar OKYC", link: "/services/aadhaar-okyc" },
      ...
      subItems: [
        {
          id: "pantogstin",
          label: "PAN to GSTIN",
          link: "/services/pan-gstin",
        },
        {
          id: "cinmca",
          label: "CIN / MCA Lookup",
          link: "/services/cin-mca-lookup",
        },
        { id: "gstin", label: "GSTIN", link: "/services/gstin" },
      ],
    },

    {
      ...
      subItems: [
        ...
        },
        {
          ...
          link: "/services/liveliness-check",
        },
        {
          id: "namematch",
          label: "Name Match",
          link: "/services/name-match",
        },
        {
          id: "reversegeo",
          label: "Reverse Geocoding",
          link: "/services/reverse-geocoding",
        },
      ],
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          link: "/services/employment-360",
        },
        {
          id: "vehiclerc",
          label: "Vehicle RC",
          link: "/services/vehicle-rc",
        },
        {
          id: "mobile360",
          label: "Mobile 360",
          link: "/services/mobile-360",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          id: "numberlooklup",
          label: "Number Lookup",
          link: "/services/number-lookup",
        },
        {
          id: "specialoffer",
          label: "Special Offer Check",
          link: "/services/special-offer-check",
        },
        {
          id: "prepaidtariff",
          label: "Prepaid Tariff Plans",
          link: "/services/prepaid-tariff-plans",
        },
        {
          id: "dthcustomer",
          label: "DTH Customer Info",
          link: "/services/dth-customer-info",
        },
        {
          id: "dthtariff",
          label: "DTH Tariff Plans",
          link: "/services/dth-tariff-plans",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          link: "/services/broadband-postpaid",
        },
        { id: "cabletv", label: "Cable TV", link: "/services/cable-tv" },
        {
          id: "clubsassoci",
          label: "Clubs & Associations",
          link: "/services/club-associations",
        },
        {
          id: "creditcard",
          label: "Credit Card",
        ...
        { id: "fastag", label: "FASTag", link: "/services/fastag" },
        { id: "gas", label: "Gas", link: "/services/gas" },
        {
          id: "hospitalpath",
          label: "Hospital & Pathology",
          link: "/services/hospital-pathology",
        },
        {
          id: "housingsociety",
          label: "Housing Society",
          link: "/services/housing-society",
        },
        {
          id: "insurance",
          label: "Insurance",
        ...
        },
        {
          ...
          link: "/services/landline-postpaid",
        },
        {
          id: "loanrepayment",
          label: "Loan Repayment",
          link: "/services/loan-repayment",
        },
        { id: "lpggas", label: "LPG Gas", link: "/services/lpg-gas" },
        {
          id: "postpaid",
          label: "Postpaid",
          link: "/services/postpaid",
        },
        {
          id: "municipalservices",
          label: "Municipal Services",
          link: "/services/municipal-services",
        },
        { id: "rental", label: "Rental", link: "/services/rental" },
        {
          id: "subscription",
          label: "Subscription",
          link: "/services/subscription",
        },
        { id: "water", label: "Water", link: "/services/water" },
      ],
    },
